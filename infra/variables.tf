...
variable "proxy_ip_address" {
  type        = string
  description = "Static IP address for the proxy VM"
}

variable "proxy_user_name" {
  type        = string
  description = "Username for the proxy VM"
}

variable "public_key_path_mn" {
  type        = string
  description = "Path to the public key file for master node"
}

variable "yc_source_bucket_name" { 
  type        = string
